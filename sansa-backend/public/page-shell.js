const SANSA_PAGES = {
  ...
  'login': {
    title: 'SANSA Access',
    pill: 'PUBLIC SITE',
    intro: 'The marketing site no longer includes a sign-in form. Open the main workspace for tools, or use Staff login in the footer for backend admin.',
    action: 'assistant',
    endpoint: '/api/health',
    features: ['Main workspace', 'Explore apps', 'Health check', 'Staff login (/admin/login)', 'Secure hosting', 'Tool sessions'],
  },
  'register': {
    title: 'SANSA Accounts',
    pill: 'PUBLIC SITE',
    intro: 'Self-service registration is not shown on this route. Use the main SANSA site to run tools without creating an account.',
    action: 'assistant',
    endpoint: '/api/health',
    features: ['Main workspace', 'Guest tools', 'Health check', 'Plans & pricing', 'Support', 'Staff login'],
  },
  'stock': {
    title: 'SANSA Stock',
    pill: 'ASSET LIBRARY',
